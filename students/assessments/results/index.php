...
$user_id = $_SESSION['user_id'];
 ...
 $stmt = $conn->prepare("SELECT * FROM studentresult_exams as SRE, examproper as E , `users` as u WHERE SRE.test_id=E.test_id  AND `course`=`test_desc` AND SRE.student_id='$user_id'");
 $stmt->execute(); 
